...
// either return false or the user object
...
app.post('/signup', function (req, res) {
  ...
  // 1. user exists should fail
  // 2. do create, which will return sparse information
  // 3. user exists again, now we should get back full info
  ...
  esClient.create({
    ...
    // perform a get of the id we just got
    // which is basically a userexists
    res.json(es_res);
